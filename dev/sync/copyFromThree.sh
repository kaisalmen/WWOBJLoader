...
cp -fv ${DIR_THREE}/examples/jsm/loaders/workerTaskManager/utils/MaterialStore.js ${DIR_BASE}/src/loaders/workerTaskManager/utils/MaterialStore.js
cp -fv ${DIR_THREE}/examples/jsm/loaders/workerTaskManager/utils/MaterialUtils.js ${DIR_BASE}/src/loaders/workerTaskManager/utils/MaterialUtils.js
cp -fv ${DIR_THREE}/examples/jsm/loaders/workerTaskManager/utils/TransportUtils.js ${DIR_BASE}/src/loaders/workerTaskManager/utils/TransportUtils.js
