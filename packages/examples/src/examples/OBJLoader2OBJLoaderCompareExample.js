...
export class OBJLoader2OBJLoaderCompareExample {
	...
	initContent() {
		...
		const onLoadMtl = function(mtlParseResult) {
			...
			objLoader.load('./models/obj/main/verify/verify.obj', function(object) {
				object.position.y = -100;
				scope.scene.add(object);
			});

			objLoader2.setMaterials(MtlObjBridge.addMaterialsFromMtlLoader(mtlParseResult));
			objLoader2.load('./models/obj/main/verify/verify.obj', callbackOnLoad, null, null, null);
		};
